...
- Suite no-real-site actual: `438 passed, 8 deselected`.
...
- [x] Primera comparación JSF válida: `PAGE=4` 42.85s vs `PAGE=2` 53.43s, ambos con cobertura completa y `0` errores.
- [ ] Repetir `PAGE=4` con `JSF HTTP=8`, categoría=`8`, detalle=`16` y HTTP=`28` constantes para confirmar reproducibilidad.
