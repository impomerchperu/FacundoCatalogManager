...
_PATCHED = False
_ORIGINAL_FULL_SYNC_PRUNE_GUARD = CategoryProductSyncService._full_sync_prune_guard
...
def _full_sync_prune_guard(
    ...
    """Recover missing codes, then delegate all safety decisions to the service."""
