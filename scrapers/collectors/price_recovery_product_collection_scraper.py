"""Product collector with broad price-field recovery semantics."""
...
class PriceRecoveryProductCollectionScraper(ProductCollectionScraper):
    """Collect products while treating every non-positive price as missing."""

    @classmethod
    def _missing_price_fields(
        cls,
        card: Any,
        product: Any,
    ) -> tuple[str, ...]:
