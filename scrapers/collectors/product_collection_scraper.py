...
class ProductCollectionScraper:
    ...
    desde su página de detalle para obtener el nombre de cada color y su
    stock correspondiente cuando la tarjeta de categoría no lo expone.
    """
    ...
    def _enrich_from_detail_page(
        ...
        """Completa colores y stock desde la página de detalle cuando hace falta."""
